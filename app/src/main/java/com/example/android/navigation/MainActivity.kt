...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NavigationUI.setupActionBarWithNavController(this, this.findNavController(R.id.myNavHostFragment), drawerLayout)
        //se incluye el menú deslizante al controlador de navegación
